...
\node[rounded corners,draw = orange,name=cell1,minimum width=24pt, minimum height=20pt]{};
...
\node[draw = pink,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell1.north){\cross};
...
\node[rounded corners,draw = orange,name=cell2,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = pink,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell2.north){\cross};
...
\node[rounded corners,draw = orange,name=cell3,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = pink,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell3.north){\cross};
...
\node[rounded corners,draw = orange,name=cell4,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = pink,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell4.north){\cross};
...
\node[rounded corners,draw = orange,name=cell5,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = pink,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell5.north){\cross};
...
\node[rounded corners,draw = orange,name=cell6,minimum width=24pt, minimum height=20pt,anchor=west,name=cell6]
...
\node[draw = pink,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell6.north){\cross};
...
\node[rounded corners,draw = orange,name=cell7,minimum width=24pt, minimum height=20pt,anchor=west]
...
\node[draw = pink,minimum width=8pt, minimum height=10pt,anchor=north,font=\tiny,inner sep=0pt]at (cell7.north){\tick};
