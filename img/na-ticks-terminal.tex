\begin{tikzpicture}[
  ...
  context/.append style={scale=0.9}
    ...
    \draw[project,->] (m-1-8) .. controls +(115:6mm) and +(30:3mm) .. (n6);
    \draw[project,->] (m-1-8) .. controls +(115:5mm) and +(30:2mm) .. (n7);
    \draw[project,->] (m-1-8) .. controls +(65:5mm) and +(150:2mm) .. (n9);
    ...
    \matrix[context-matrix] (m2) at (0,-1) {
      ...
      & |[state,state-n]| & |[context]|
      & |[state,state-n]| & |[context]|
      & |[state,state-n,draw=green!50!blue,fill=green!20]|7 & |[context]| \\
    };
    ...
    \node[looplabel] at ([shift={(0,-0.3)}]m2.south) {Terminal};
\end{tikzpicture}
